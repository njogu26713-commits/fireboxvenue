...
type ServiceForm = { title: string; description: string; imageUrl: string; sortOrder: string };
type ProjectForm = { title: string; client: string; description: string; imageUrl: string; sortOrder: string };

const emptyService: ServiceForm = { title: "", description: "", imageUrl: "", sortOrder: "0" };
const emptyProject: ProjectForm = { title: "", client: "", description: "", imageUrl: "", sortOrder: "0" };
...
export default function Admin() {
  ...
  const submitService = (event: FormEvent) => {
    ...
    const input = { ...service, imageUrl: service.imageUrl || undefined, sortOrder: Number(service.sortOrder) || 0 };
  ...
  const submitProject = (event: FormEvent) => {
    event.preventDefault();
    const input = { ...project, imageUrl: project.imageUrl || undefined, sortOrder: Number(project.sortOrder) || 0 };
