...
type ServiceForm = { title: string; description: string; sortOrder: string };
type ProjectForm = { title: string; client: string; description: string; imageUrl: string; sortOrder: string };

const emptyService: ServiceForm = { title: "", description: "", sortOrder: "0" };
...
export default function Admin() {
  ...
  const submitService = (event: FormEvent) => {
    ...
    const input = { ...service, sortOrder: Number(service.sortOrder) || 0 };
