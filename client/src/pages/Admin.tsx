      ...
      <div className="mx-auto max-w-[1500px] px-5 py-10 sm:px-8 sm:py-14 lg:px-12">
        ...
        <div className="mt-10 grid gap-10 xl:grid-cols-[11rem_minmax(0,0.85fr)_minmax(0,1.15fr)]">
          <nav aria-label="Admin sections" className="flex gap-2 overflow-x-auto border border-white/10 bg-[#080b11] p-3 xl:hidden">
            {adminNavItems.map(([id, label]) => <a key={id} href={`#${id}`} className="shrink-0 border border-white/10 px-3 py-2 font-[IBM_Plex_Mono] text-[9px] tracking-[0.12em] text-[#9da9b8] transition hover:border-[#ff5a1f] hover:text-[#ff5a1f]">{label}</a>)}
          </nav>
          <aside className="hidden xl:block">
            <nav aria-label="Admin sections" className="sticky top-6 border border-white/10 bg-[#080b11] p-3">
              <p className="border-b border-white/10 px-2 pb-3 font-[IBM_Plex_Mono] text-[9px] tracking-[0.16em] text-[#6ae4ff]">ADMIN INDEX</p>
              <div className="mt-2 space-y-1">{adminNavItems.map(([id, label]) => <a key={id} href={`#${id}`} className="block border-l border-transparent px-2 py-2 font-[IBM_Plex_Mono] text-[9px] tracking-[0.1em] text-[#9da9b8] transition hover:border-[#ff5a1f] hover:bg-[#ff5a1f]/5 hover:text-[#ff5a1f]">{label}</a>)}</div>
            </nav>
          </aside>
