      ...
      >
        ...
        <header className="relative z-20 flex items-center justify-between px-5 py-5 sm:px-8 sm:py-7 lg:px-12">
          ...
          <div className="flex items-center gap-2 sm:gap-3 lg:gap-5">
            ...
            <a href="/faq" className="group hidden h-10 items-center gap-2 border border-white/20 bg-white/[0.06] px-3.5 font-sans text-[10px] font-medium tracking-[0.14em] text-white backdrop-blur-md transition duration-200 hover:border-[#ff5a1f]/80 hover:bg-[#ff5a1f] hover:text-[#07090d] active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff5a1f] focus-visible:ring-offset-4 focus-visible:ring-offset-[#05070b] sm:inline-flex sm:h-11 sm:px-4">
              FAQ
              <ArrowUpRight className="h-3.5 w-3.5 transition-transform duration-200 group-hover:-translate-y-0.5 group-hover:translate-x-0.5" strokeWidth={2.2} />
            </a>
            <a href="/products" className="hidden h-10 items-center border border-white/20 bg-white/[0.06] px-3 font-sans text-[10px] font-medium tracking-[0.12em] text-white backdrop-blur-md transition duration-200 hover:border-[#ff5a1f]/80 hover:bg-[#ff5a1f] hover:text-[#07090d] active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff5a1f] lg:inline-flex lg:h-11">
              PRODUCTS
            </a>
            <a href="/developers" className="hidden h-10 items-center border border-white/20 bg-white/[0.06] px-3 font-sans text-[10px] font-medium tracking-[0.12em] text-white backdrop-blur-md transition duration-200 hover:border-[#ff5a1f]/80 hover:bg-[#ff5a1f] hover:text-[#07090d] active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff5a1f] lg:inline-flex lg:h-11">
              DEVELOPERS
            </a>
            <a href="/docs" className="hidden h-10 items-center border border-white/20 bg-white/[0.06] px-3 font-sans text-[10px] font-medium tracking-[0.12em] text-white backdrop-blur-md transition duration-200 hover:border-[#ff5a1f]/80 hover:bg-[#ff5a1f] hover:text-[#07090d] active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ff5a1f] lg:inline-flex lg:h-11">
              DOCS
            </a>
            <a
              href="/support"
          ...
          {menuOpen && (
            <div className="absolute right-5 top-[calc(100%-0.25rem)] z-30 w-[min(16rem,calc(100vw-2.5rem))] border border-white/15 bg-[#080c13]/95 p-2 shadow-[0_18px_60px_rgba(0,0,0,0.45)] backdrop-blur-xl sm:hidden">
              <a href="/solutions" onClick={() => setMenuOpen(false)} className="group flex h-12 items-center justify-between border border-[#ff5a1f]/70 bg-[#ff5a1f] px-3.5 font-sans text-[10px] font-semibold tracking-[0.14em] text-[#07090d] transition hover:bg-[#6ae4ff]">
                SOLUTIONS
              ...
              <a href="/support" onClick={() => setMenuOpen(false)} className="group mt-2 flex h-12 w-full items-center justify-between border border-white/20 bg-white/[0.06] px-3.5 text-left font-sans text-[10px] font-semibold tracking-[0.14em] text-white transition hover:border-[#6ae4ff] hover:text-[#6ae4ff]">
                OPEN CHANNEL
                <ArrowUpRight className="h-4 w-4 transition-transform duration-200 group-hover:-translate-y-0.5 group-hover:translate-x-0.5" strokeWidth={2.2} />
              </a>
              <a href="/faq" onClick={() => setMenuOpen(false)} className="group mt-2 flex h-12 w-full items-center justify-between border border-white/20 bg-white/[0.06] px-3.5 text-left font-sans text-[10px] font-semibold tracking-[0.14em] text-white transition hover:border-[#6ae4ff] hover:text-[#6ae4ff]">
                FAQ
                <ArrowUpRight className="h-4 w-4 transition-transform duration-200 group-hover:-translate-y-0.5 group-hover:translate-x-0.5" strokeWidth={2.2} />
              </a>
              <a href="/products" onClick={() => setMenuOpen(false)} className="group mt-2 flex h-12 w-full items-center justify-between border border-white/20 bg-white/[0.06] px-3.5 text-left font-sans text-[10px] font-semibold tracking-[0.14em] text-white transition hover:border-[#6ae4ff] hover:text-[#6ae4ff]">
                PRODUCTS
                <ArrowUpRight className="h-4 w-4 transition-transform duration-200 group-hover:-translate-y-0.5 group-hover:translate-x-0.5" strokeWidth={2.2} />
              </a>
              <a href="/developers" onClick={() => setMenuOpen(false)} className="group mt-2 flex h-12 w-full items-center justify-between border border-white/20 bg-white/[0.06] px-3.5 text-left font-sans text-[10px] font-semibold tracking-[0.14em] text-white transition hover:border-[#6ae4ff] hover:text-[#6ae4ff]">
                DEVELOPERS
                <ArrowUpRight className="h-4 w-4 transition-transform duration-200 group-hover:-translate-y-0.5 group-hover:translate-x-0.5" strokeWidth={2.2} />
              </a>
              <a href="/docs" onClick={() => setMenuOpen(false)} className="group mt-2 flex h-12 w-full items-center justify-between border border-white/20 bg-white/[0.06] px-3.5 text-left font-sans text-[10px] font-semibold tracking-[0.14em] text-white transition hover:border-[#6ae4ff] hover:text-[#6ae4ff]">
                DOCS
                <ArrowUpRight className="h-4 w-4 transition-transform duration-200 group-hover:-translate-y-0.5 group-hover:translate-x-0.5" strokeWidth={2.2} />
              </a>
            </div>
        ...
        <div aria-hidden="true" className="absolute bottom-24 right-5 z-10 hidden items-center gap-3 md:flex lg:right-12">
          <span className="font-sans text-[9px] tracking-[0.18em] text-[#8fa0b4]">FURNACE // 01</span>
